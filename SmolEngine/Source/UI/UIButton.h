...
namespace SmolEngine
{
	...
	private:
		...
		{
			archive(m_ID, m_Type, m_TetxureName, m_TexturePath, m_Size.x, m_Size.y, m_UCood.x, m_UCood.y,
				maxX, maxY, minX, minY, m_isHovered, m_isPressed, m_PressedColorEnabled,
				m_HoveredColor.r, m_HoveredColor.g, m_HoveredColor.b, m_PressedColor.r,
				m_PressedColor.g, m_PressedColor.b, m_CurrentColor.r, m_CurrentColor.g, m_CurrentColor.b);
		}
	};
}